        ...
        <section className="relative overflow-hidden py-10 sm:py-14 lg:py-16">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:items-center">
            ...
            <div className="pt-6 lg:pt-0">
              ...
              {/* ====== CONTACT INFO — right below description ====== */}
              <div className="mt-6 flex flex-wrap items-center gap-4 rounded-xl bg-white/70 p-4 shadow-sm ring-1 ring-black/5 backdrop-blur-sm sm:p-5">
                <a
                  href="tel:09989562468"
                  className="inline-flex items-center gap-2 rounded-full bg-[#1d8d8a] px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-[#177a77] hover:scale-105"
                >
                  <Phone className="h-4 w-4" />
                  Call Now
                </a>
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                  <span className="text-base font-bold text-[#0c2222] sm:text-lg">
                    0998 956 2468
                  </span>
                  <span className="hidden h-5 w-px bg-black/10 sm:block" />
                  <span className="text-sm text-[#68817f]">
                    📋 By Appointment Only
                  </span>
                </div>
              </div>
