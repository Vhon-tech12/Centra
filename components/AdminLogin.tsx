...
const AdminLogin = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex w-full flex-col items-center justify-center bg-gradient-to-br from-teal-50/80 via-cyan-50/60 to-white px-6 py-12 md:w-1/2 lg:px-12">
        <div className="w-full max-w-md">
          {/* Logo/Icon */}
          <div className="mb-8 flex items-center justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-600 to-cyan-600 text-3xl shadow-lg shadow-teal-200">
              🏥
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  placeholder="admin@centraclinic.com"
                  value={email}
      ...
      <div className="hidden md:block md:w-1/2 relative">
        <div className="relative h-full w-full">
          <img
            src="/centraLogo.jpg"
            alt="Centra Clinic - Excellence in Healthcare"
          ...
          <div className="absolute bottom-0 left-0 right-0 p-12 text-white">
            <div className="max-w-md">
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                Streamline your clinic operations with our comprehensive administration platform.
              </p>
              <div className="mt-4 flex gap-6">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></span>
                  <span className="text-sm text-white/80">Secure Management</span>
                </div>
                <div className="flex items-center gap-2">
