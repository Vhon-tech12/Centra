...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Close only the desktop user dropdown on scroll; keep mobile menu open
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu – improved height and scrolling */}
        <div
          className={`lg:hidden overflow-hidden transition-all duration-300 ease-out ${
            isOpen ? "max-h-[calc(100vh-100px)] opacity-100" : "max-h-0 pb-0 opacity-0"
          }`}
        >
          <div className="mt-1 rounded-[28px] border border-[#dbe9e7] bg-white/90 p-4 shadow-[0_16px_40px_rgba(16,37,37,0.08)] backdrop-blur-xl sm:p-5 overflow-y-auto max-h-[calc(100vh-120px)]">
